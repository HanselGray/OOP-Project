...
public class DynastyScrapeMain implements ICombineData, IWriteJson {
    ...
    public void writeJSon() throws JsonIOException, IOException {
        String filePath = new File(System.getProperty("user.dir")).getParent() + "/OOP-BIG/src/main/data/dynasties.json";
