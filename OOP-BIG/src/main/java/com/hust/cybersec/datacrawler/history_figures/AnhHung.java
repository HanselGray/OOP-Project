...
public class AnhHung extends BasicDataCrawler {
    ...
    public AnhHung() {
        this.url = "https://giaoduc.net.vn/nhung-duong-pho-mang-ten-cac-vi-tuong-linh-va-si-quan-quan-doi-post173227.gd";
        connect();
    }
